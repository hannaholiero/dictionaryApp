...
interface FavoriteIconProps {
  ...
  onToggleFavorite: () => void; // Funktion som togglar favoritstatus
}
...
const FavoriteIcon: React.FC<FavoriteIconProps> = ({
  ...
  return (
    ...
    >
      {isFavorite ? (
        // Ikon för att ta bort från favoriter (fylld hjärta)
        <svg
        ...
        // Ikon för att lägga till till favoriter (tomt hjärta)
        <svg
          xmlns="http://www.w3.org/2000/svg"
          fill="none"
          viewBox="0 0 24 24"
